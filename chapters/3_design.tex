...
A kvízhez öt osztályzati sáv definiálható (kiváló, jó, közepes, elégséges, elégtelen), amelyek százalékos küszöbértékekhez kötöttek. Az oktató a ponthatárokat utólag is módosíthatja; ebben az esetben a \texttt{QuizService} automatikusan újraszámítja az összes, adott kvízhez tartozó korábbi eredmény osztályzatát. Ez a döntés azzal az előnnyel jár, hogy az oktatók a kvíz kiértékelése után is finomíthatják a pontozási rendszert anélkül, hogy a hallgatóknak újra kellene tölteniük a tesztet.
